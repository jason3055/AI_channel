...
- Private messaging is envelope-based MVP; activity sync, CLI hosted backup integration, and retention cleanup are still risk areas.
...
- Hosted backup server storage exists; CLI upload/restore integration and activity sync are not implemented yet.
